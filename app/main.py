...
from app.sql_utils import extract_sql, strip_unrequested_where, expand_to_select_star, validate_sql, validate_sql_against_schema, execute_query
...
def ask_database(request: AskRequest):
    try:
        ...
        sql = expand_to_select_star(sql, request.question)
        print("EXTRACTED SQL:\n", sql)
